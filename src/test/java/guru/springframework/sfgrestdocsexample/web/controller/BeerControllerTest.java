        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("beerStyle").description("Style if the beer"),
        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer-new",
                    requestFields(
                            ...
                            fields.withPath("beerStyle").description("Style if the beer"),
                            fields.withPath("upc").description("UPC of the beer").attributes(),
                            fields.withPath("price").description("Unit price"),
